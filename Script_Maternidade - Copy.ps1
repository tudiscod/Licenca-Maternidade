...
foreach ($usuario in $usuarios) {
    ...
    # Verificar se esses usuários estão no grupo G-DEN-GD-Maternidade
    ...
    if ($usuarioNoGrupoMaternidade) {
        ...
        # Adicionar o usuário ao grupo G-DEN-GD-Maternidade
        ...
        # Preparar ação para remover o usuário após 150 dias do grupo G-DEN-GD-Maternidade
